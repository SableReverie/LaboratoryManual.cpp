...
int main () {
    ...
    cout << "The smallest is at index: " << smallestIndex << endl;
    cout << "The smallest element is: " << arr[smallestIndex] << endl;
    cout << "The largest is at index: " << largestIndex << endl;
    cout << "The largest element is: " << arr[largestIndex] << endl;
...
const int ROWS = 10, SEATS_PER_ROW = 6;
std::vector<std::vector<bool>> seats(ROWS, std::vector<bool>(SEATS_PER_ROW, false));

bool displaySeats(bool seats[][SEATS_PER_ROW]);
